...
class Main(QDialog):
    ...
    def init_ui(self):
        ...
        ### 숫자 버튼 생성하고, layout_sign 레이아웃에 추가
        ...
        for number in range(0, 24):
            ...
            button_list[i].clicked.connect(lambda state, sign = button_signs[i]: self.sign_button_clicked(sign))self.sign_button_clicked(sign))
